...
class Connection extends Base
{
     ...
     * @param object $access  { 'token': string, 'expires': seconds, 'timestamp': unixtime }
     */
     ...
     * Get the access info.
     *
     * @return object  { 'token': string, 'expires': seconds, 'timestamp': unixtime }
     */
    public function getAccessInfo()
    {
        return isset($this->accessToken) ? (object)array('token' => $this->accessToken, 'expires' => $this->accessExpires, 'timestamp' => $this->accessTimestamp) : null;
    }
